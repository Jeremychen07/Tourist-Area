  ...
  var picurl="./sea.jpg";
    for(let i=0;i<100;i++)
    {
        ...
        card.innerHTML+=
          ...
          +"<div class='top'><div class='title'>"+(product.Name.substr(18,1)!=""?product.Name.substr(0,18)+"...":product.Name.substr(0,18))+"</div>"
          ...
          +"<div class='text'>說明:<br>"+product.Description.substr(0,100)+"...</div>"
